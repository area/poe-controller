...
public class MacroCharacterMovement extends Macro {
	...
	public void performMacro(Event event, ConfigMacro macro, ActionHandlerMacro actionHandlerMacro) {
		...
		log(2, Math.abs(this.stickXAxis));
		log(2, Math.abs(settings.getStickThreshold()));
		...
		// 		robot.mouseMove((int) this.pointCharacterCenter.x, (int) this.pointCharacterCenter.y);
		// 	}
	}
